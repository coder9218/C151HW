...
profits = (20000,45000,78000,97000,456000,65000,54000,10000,30000,70000,90000)
...
def maxProfit():
    ...
    label_max_profit['text'] =" Max profit of "+ str(max_profit)+" was given in the month of " + str(max_profit_month)

def minProfit():
    min_profit = min(profits)
    min_profit_index = profits.index(min_profit)
    min_profit_month[min_profit_index]
    label_min_profit['text'] =" Min profit of "+ str(min_profit)+" was given in the month of " + str(min_profit_month)
